...
class QuizCard extends React.Component {
  static messageDuration(message, wordsPerMinute = 200, minimunDuration = 5000) {
    /**
     ...
     * @return {float} The number of milliseconds it would take to read the message.
     */
    ...
    return timeToRead > minimunDuration ? timeToRead : minimunDuration;
  }
